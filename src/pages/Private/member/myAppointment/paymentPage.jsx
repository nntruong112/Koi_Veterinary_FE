...
// //         setError("Error creating payment: " + error.message); // More descriptive error message
// //       } finally {
// //         setIsLoading(false);
// //       }
// //     };
...
//   const [error, setError] = useState(null);
//   const [isLoading, setIsLoading] = useState(false);
//   const [paymentDetails, setPaymentDetails] = useState(null); // State để lưu chi tiết payment
//   const userId = useSelector((state) => state.users.data?.result?.userId);
...
//     if (responseCode === "00" && paymentId) {
//       // Giả sử bạn có API để lấy thông tin chi tiết payment
//       axios
//         .get(`http://localhost:8080/payments/details/${paymentId}`)
//         .then((res) => {
//           setPaymentDetails(res.data); // Lưu chi tiết payment vào state
//         })
//         .catch((err) => {
...
//       {/* Hiển thị thông tin chi tiết Payment sau khi thanh toán thành công */}
//       {paymentDetails && (
