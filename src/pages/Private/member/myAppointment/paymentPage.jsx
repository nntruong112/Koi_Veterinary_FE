...
const PaymentPage = () => {
  ...
  return (
    <div className="payment-page w-full max-w-lg mx-auto p-8 bg-white shadow-xl rounded-xl my-10 border border-gray-200">
      <h1 className="text-4xl font-extrabold mb-8 text-center text-gray-800">
        Koi Health Service Payments
      </h1>
      ...
      {paymentResponse && (
        <div className="flex flex-col items-center w-full border rounded-xl p-5 shadow-lg text-lg mb-4">
          ...
          <a href={paymentUrl} target="_blank" rel="noopener noreferrer">
            <button className="mt-4 px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-500 transition duration-300">
              Make Payment
            </button>
          </a>
        </div>
      ...
      {/* Uncomment to display Payment Details after successful payment */}
      {/* {paymentDetails && (
        <div className="mt-10 p-6 bg-gray-100 rounded-xl shadow-lg">
          <h2 className="text-2xl font-semibold mb-4">Payment Details</h2>
          <div className="grid grid-cols-2 gap-4 text-lg">
            ...
            <div>
              <strong>Date:</strong> {new Date(paymentDetails.payDate).toLocaleDateString()}
            </div>
            <div>
              <strong>Order Type:</strong> {paymentDetails.orderType}
            </div>
