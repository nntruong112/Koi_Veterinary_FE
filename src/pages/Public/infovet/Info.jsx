      ...
      <>
        ...
        <div className="flex-1 border border-gray-400 rounded-lg p-8  py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0 ">
          ...
          <div className="flex items-center gap-2 text-sm mt-1 ">
            <p>Internal Surgery for Koi fish</p>
          ...
          <div>
            ...
            <p className="text-sm max-w-[700px] mt-1">
              {" "}
              Dr. Olympia has a = > {
              } strong commitment to delivering comprehensive
              medical care, focusing on preventive medicine, early diagnosis,
              and effective treatment strategies. Dr. Johnny Sins has a strong
